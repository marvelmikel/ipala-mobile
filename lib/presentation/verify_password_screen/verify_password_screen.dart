...
class VerifyPasswordScreen extends GetWidget<VerifyPasswordController> {
  @override
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: Padding(
                              padding: getPadding(left: 24, top: 35),
                      ...
                      Align(
                          ...
                          child: Container(
                              ...
                              margin: getMargin(left: 24, top: 5),
                              child: Text("msg_enter_the_six_digit4".tr,
                                  maxLines: null,
                                  textAlign: TextAlign.left,
                                  style: AppStyle
                                      ...
                                      .copyWith(
                                          height: getVerticalSize(1.30))))),
                      Padding(
                          padding: getPadding(left: 50, top: 23, right: 50),
                          child: Obx(() => PinCodeTextField(
                              ...
                              onChanged: (value) {},
                              pinTheme: PinTheme(
                                  fieldHeight: getHorizontalSize(42.00),
                                  fieldWidth: getHorizontalSize(42.00),
                          ...
                          child: Row(
                              ...
                              children: [
                                Text("lbl_resend_otp".tr,
                                    ...
                                    textAlign: TextAlign.left,
                                    style: AppStyle
                                        .txtJosefinSansRomanRegular14Orange700
                                        .copyWith(
                                            height: getVerticalSize(1.30),
                                            decoration:
                                ...
                                Text("lbl_1_00".tr,
                                    ...
                                    textAlign: TextAlign.left,
                                    style: AppStyle
                                        .txtJosefinSansRomanRegular14Black900e5
                                        .copyWith(
                                            height: getVerticalSize(1.30)))
                              ])),
                      CustomButton(

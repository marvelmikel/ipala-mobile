...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  onTapStorehomepage() {
    Get.toNamed(AppRoutes.storeHomepageScreen);
  }
  ...
  onTapProductpageOne() {
    Get.toNamed(AppRoutes.productPageOneScreen);
  }
  ...
  onTapEnablenotification() {
    Get.toNamed(AppRoutes.enableNotificationScreen);
  }
  ...
  onTapPersonallisting() {
    Get.toNamed(AppRoutes.personalListingScreen);
  }

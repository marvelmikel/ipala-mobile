...
class ListgoogleThreeItemWidget extends StatelessWidget {
  ListgoogleThreeItemWidget(this.listgoogleThreeItemModelObj);

  ListgoogleThreeItemModel listgoogleThreeItemModelObj;

...
class ListgoogleSixItemWidget extends StatelessWidget {
  ListgoogleSixItemWidget(this.listgoogleSixItemModelObj);

  ListgoogleSixItemModel listgoogleSixItemModelObj;

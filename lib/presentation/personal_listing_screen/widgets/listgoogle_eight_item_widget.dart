...
class ListgoogleEightItemWidget extends StatelessWidget {
  ListgoogleEightItemWidget(this.listgoogleEightItemModelObj);

  ListgoogleEightItemModel listgoogleEightItemModelObj;
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            ...
            overflow: TextOverflow.ellipsis,
            textAlign: TextAlign.left,
            style: AppStyle.txtJosefinSansRomanMedium16Deeporange600,
          ),
        ),
      ],
    );

                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      child: RichText(
                                                                                          text: TextSpan(children: [
                                                                                            TextSpan(text: "lbl_contact_us".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(12), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400)),
                                                                                            TextSpan(text: "lbl2".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(24), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400)),
                                                                                            TextSpan(text: "lbl_whatsapp".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(12), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400, decoration: TextDecoration.underline)),
                                                                                            TextSpan(text: "lbl2".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(24), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400)),
                                                                                            TextSpan(text: "lbl_email".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(12), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400, decoration: TextDecoration.underline)),
                                                                                            TextSpan(text: "  ".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(12), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400)),
                                                                                            TextSpan(text: "lbl3".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(24), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400)),
                                                                                            TextSpan(text: "lbl_website".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(12), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400, decoration: TextDecoration.underline)),
                                                                                            TextSpan(text: "  ".tr, style: TextStyle(color: ColorConstant.fromHex("#e50f0400"), fontSize: getFontSize(16), fontFamily: 'Josefin Sans', fontWeight: FontWeight.w400))
                                                                                          ]),
                                                                                          textAlign: TextAlign.left))),

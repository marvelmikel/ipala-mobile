...
class StoreHomepageItemWidget extends StatelessWidget {
  StoreHomepageItemWidget(this.storeHomepageItemModelObj);

  StoreHomepageItemModel storeHomepageItemModelObj;

  var controller = Get.find<StoreHomepageController>();
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            ...
            overflow: TextOverflow.ellipsis,
            textAlign: TextAlign.left,
            style: AppStyle.txtJosefinSansRomanMedium12Deeporange600.copyWith(
              height: getVerticalSize(
                1.30,
              ),
            ),

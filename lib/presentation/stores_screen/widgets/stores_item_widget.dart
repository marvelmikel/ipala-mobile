...
class StoresItemWidget extends StatelessWidget {
  StoresItemWidget(this.storesItemModelObj);

  StoresItemModel storesItemModelObj;

  var controller = Get.find<StoresController>();
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: AppStyle.txtJosefinSansRomanRegular8,
              ),
              Padding(
                padding: getPadding(
                  top: 4,
              ...
              Padding(
                ...
                child: Text(
                  ...
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.left,
                  style: AppStyle.txtJosefinSansRomanRegular12,
                ),
              ),
              CustomButton(
                height: 26,
